...
easyhttp.get('dist/js/content/projects.json')
    .then(projects => {
            ...
            <div class="col-md-6 d-flex justify-content-end mt-4">
                <div class="project-card">
                    <div class="project-image">
                        <img src="${project.projectImage}" alt="" class="w-100 h-100">
                    </div>
...
easyhttp.get('dist/js/content/skills.json')
    .then(skills => {
...
easyhttp.get('dist/js/content/services.json')
    .then(services => {
...
function toggleSideBar(status) {
    if(status) {
        menuButton.firstElementChild.firstElementChild.classList.replace("fa-bars","fa-times");
        sidebar.classList.add('sidebar-toggle');
        overlay.classList.add('overlay-toggle');
    } else {
        menuButton.firstElementChild.firstElementChild.classList.replace("fa-times","fa-bars");
